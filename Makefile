...
count_mis2_er:
	$(JL) -t 100 -e 'include("count_mis/count_mis2.jl"); count_mis(ErdosRenyiGraphSpec($(i), $(p)))' 2>&1 | tee log/count_mis2_er_$(i).log

count_lp_er:
	$(JL) -t 100 -e 'include("count_mis/count_lp.jl"); count_mis(ErdosRenyiGraphSpec($(i), $(p)), 2)' 2>&1 | tee log/count_lp_er_$(i).log

count_ip_er:
	$(JL) -t 100 -e 'include("count_mis/count_ip.jl"); count_mis(ErdosRenyiGraphSpec($(i), $(p)), 2)' 2>&1 | tee log/count_ip_er_$(i).log

count_mis2_ksg:
	$(JL) -t 100 -e 'include("count_mis/count_mis2.jl"); count_mis(KSGSpec($(m), $(n), $(filling)))' 2>&1 | tee log/count_mis2_ksg_$(m)_$(n).log

count_lp_ksg:
	$(JL) -t 100 -e 'include("count_mis/count_lp.jl"); count_mis(KSGSpec($(m), $(n), $(filling)), 2)' 2>&1 | tee log/count_lp_ksg_$(m)_$(n).log

count_ip_ksg:
	$(JL) -t 100 -e 'include("count_mis/count_ip.jl"); count_mis(KSGSpec($(m), $(n), $(filling)), 2)' 2>&1 | tee log/count_ip_ksg_$(m)_$(n).log

count_mis2_sq:
	$(JL) -t 100 -e 'include("count_mis/count_mis2.jl"); count_mis(GridSpec($(m), $(n), $(filling)))' 2>&1 | tee log/count_mis2_sq_$(m)_$(n).log

count_lp_sq:
	$(JL) -t 100 -e 'include("count_mis/count_lp.jl"); count_mis(GridSpec($(m), $(n), $(filling)), 2)' 2>&1 | tee log/count_lp_sq_$(m)_$(n).log

count_ip_sq:
	$(JL) -t 100 -e 'include("count_mis/count_ip.jl"); count_mis(GridSpec($(m), $(n), $(filling)), 2)' 2>&1 | tee log/count_ip_sq_$(m)_$(n).log
