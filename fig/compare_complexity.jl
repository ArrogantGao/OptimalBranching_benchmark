...
ms = 12
marker_styles = [:circle, :diamond, :utriangle, :hexagon]
colors = [:blue, :green, :red, :purple]
locs_x = [150, 120, 220, 100]
locs_y = [100000, 1000, 5000, 10]
labels = ["mis2", "opt_branching_lp", "opt_branching_ip", "xiao2013"]
nss = [ns_mis2, ns_setcover, ns_setcover, ns_xiao]
fit = [fit_mis2, fit_lp, fit_ip, fit_xiao]
begin
    ...
    for (i, count) in enumerate([count_mis2, count_lp, count_ip, count_xiao])
